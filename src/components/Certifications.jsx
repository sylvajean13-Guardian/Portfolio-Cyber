...
const content = {
  fr: {
    ...
    idLabel: "ID",
    certifications: [
      { title: "Building LLM Applications with Prompt Engineering", issuer: "NVIDIA", date: "Avril 2026", id: "v4rq1bLWQO-q2Ymc5WeYfw" },
      { title: "DFIR Foundations and Techniques Course — Professional Skills and Readiness", issuer: "Blue Cape Security", date: "Août 2026", id: "11082026" },
      { title: "Introduction to Cybersecurity", issuer: "Cisco Networking Academy", date: "Janvier 2025" },
    ],
    achievements: [
  ...
  en: {
    ...
    idLabel: "ID",
    certifications: [
      { title: "Building LLM Applications with Prompt Engineering", issuer: "NVIDIA", date: "April 2026", id: "v4rq1bLWQO-q2Ymc5WeYfw" },
      { title: "DFIR Foundations and Techniques Course — Professional Skills and Readiness", issuer: "Blue Cape Security", date: "August 2026", id: "11082026" },
      { title: "Introduction to Cybersecurity", issuer: "Cisco Networking Academy", date: "January 2025" },
    ],
    achievements: [
            ...
            <div className="space-y-4">
              {t.certifications.map((cert, index) => (
                <motion.div
                  ...
                  className="rounded-2xl border border-[var(--border-color)] bg-[var(--surface)]/40 p-6 transition hover:border-[var(--primary)]/40"
                >
