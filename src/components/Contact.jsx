...
const content = {
  fr: {
    ...
    title1: "Sécurisons",
    title2: "ce qui vient.",
    subtitle: "Ouvert aux opportunités en cybersécurité, aux rôles SOC, à l'ingénierie sécurité et aux collaborations internationales.",
  ...
  en: {
    ...
    title1: "Let's secure",
    title2: "what's next.",
    subtitle: "Open to cybersecurity opportunities, SOC roles, security engineering and international collaborations.",
